...
namespace Cliente.Infrastructure.BackgroundServices
{
    public class ErroGeracaoCartaoWorker : BackgroundService
    {
        private readonly ILogger<ErroGeracaoCartaoWorker> _logger;
        ...
        public ErroGeracaoCartaoWorker(ILogger<ErroGeracaoCartaoWorker> logger)
        {
            _logger = logger;
    ...
    public class CustomAsyncConsumer : AsyncDefaultBasicConsumer
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                _logger.LogWarning("⚠️ Falha na geração do cartão - ClienteId: {ClienteId}, Status: {Status}, Erro: {MensagemErro}",
